...
export default function MenuCard({ items, title }) {
  return (
    <div className="flex flex-wrap justify-center place-content-around">
      {items.map((item) => (
        <div key={item.id}>
            ...
            <div className="md:flex shadow-lg  mx-6 md:mx-auto my-20 max-w-lg md:max-w-2xl h-64">
              ...
              <div className="w-full md:w-2/3 px-4 py-4 bg-white rounded-lg">
                <div className="flex items-center">
                  ...
                  <div className="price">
                    <p className="text-gray-800 font-semi tracking-tighter">
                      ${item.price}
                    </p>
                  </div>
                </div>
                <p className=" description text-sm text-gray-700 mt-4">
                  {item.description}
                </p>
              </div>
            </div>
